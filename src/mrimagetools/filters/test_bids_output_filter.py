...
def structural_input_fixture(asldro_version) -> Tuple[NiftiImageContainer, dict]:
    ...
    d = {
        ...
        "PulseSequenceDetails": f"Digital Reference Object Data generated by ASLDRO, version {asldro_version}",
    }
    return (image, d)
...
def test_bids_output_filter_dataset_description(asldro_version):
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        with open(os.path.join(temp_dir, "dataset_description.json")) as json_file:
            loaded_json = json.load(json_file)
        assert loaded_json == {
...
def test_bids_output_filter_readme():
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        with open(os.path.join(temp_dir, "README"), "r") as readme_file:
...
def test_bids_output_filter_bidsignore():
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        with open(os.path.join(temp_dir, ".bidsignore"), "r") as file:
            actual = file.read()
            file.close()
